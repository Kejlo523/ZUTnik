...
public class ZutnikApi {

    private static final String ZUT_API_BASE = "https://www.zut.edu.pl/app-json-proxy/index.php";

    public static JSONObject callApi(String fn, Map<String, String> params)
            throws IOException, JSONException {

        // Build URL
        String urlStr = ZUT_API_BASE + "?f=" + java.net.URLEncoder.encode(fn, "UTF-8");
        ...
        Request request = new Request.Builder()
                ...
                .header("User-Agent", "ZUTnik-Android/1.0")
                .build();
