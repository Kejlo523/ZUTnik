...
public class PlanRepository {
    ...
    private static final String TAG = "ZUTnik-PLAN";
    ...
    private List<SubjectFilterItem> buildSubjectFilterItems(
        ...
        for (String normalizedSubject : normalizedKeys) {
            ...
            if (types.contains("lek")) {
                SubjectFilterItem it = new SubjectFilterItem();
                it.label = subject;
                it.typeKey = "lek";
                it.typeLabel = getFilterTypeLabel("lek");
                it.filterKey = subject + "||lek";
                items.add(it);
            }
        }
    ...
    private String resolveFilterTypeKey(PlanEventRaw e) {
        ...
        if (typeClass.endsWith("-lectorate")) {
            return "lek";
        }
        ...
        if (form.contains("lektorat") || form.contains("lectorate") || form.contains("language course")) {
            return "lek";
        }
        ...
        if (appContext != null) {
            switch (typeKey) {
                ...
                case "lab":
                    return appContext.getString(R.string.plan_type_lab);
                case "lek":
                    return appContext.getString(R.string.plan_type_lectorate);
                default:
                    return "";
            }
        }
