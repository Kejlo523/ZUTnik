...
public class FinanceActivity extends MzutBaseActivity implements FinanceAdapter.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!MzutSession.getInstance().isLoggedIn()) {
        ...
        android.view.View drawerContentRoot = findViewById(R.id.drawerContentRoot);
        drawerLayout = findViewById(R.id.drawerLayout);
        navigationView = findViewById(R.id.navigationView);
        toolbar = findViewById(R.id.toolbar);

        ViewCompat.setOnApplyWindowInsetsListener(drawerContentRoot, (v, insets) -> {
        ...
        NavDrawerHelper.setupNavigation(
                ...
                navigationView,
                toolbar,
                NavDrawerHelper.Screen.FINANCE);
        toolbar.setTitle(R.string.finance_title);

        spinnerStudies = findViewById(R.id.spinnerStudies);
        filterGroup = findViewById(R.id.financeFilterGroup);
        listFinance = findViewById(R.id.listFinance);
        emptyView = findViewById(R.id.financeEmptyView);
        progressView = findViewById(R.id.financeProgress);
        refreshButton = findViewById(R.id.btnFinanceRefresh);
        summaryDueValue = findViewById(R.id.tvFinanceSummaryDueValue);
        summaryPaidValue = findViewById(R.id.tvFinanceSummaryPaidValue);
        summaryOpenCountValue = findViewById(R.id.tvFinanceSummaryOpenValue);
        summaryOverpaidValue = findViewById(R.id.tvFinanceSummaryOverpaidValue);
        noticeDateView = findViewById(R.id.tvFinanceNoticeDate);
        noticeHeader = findViewById(R.id.financeNoticeHeader);
        noticeContent = findViewById(R.id.financeNoticeContent);
        noticeChevron = findViewById(R.id.financeNoticeChevron);

        financeRepository = new FinanceRepository(this);

        financeAdapter = new FinanceAdapter(this);
        listFinance.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void setupStudiesSpinner() {
        studiesAdapter = new ArrayAdapter<>(this, R.layout.spinner_item_dark, new ArrayList<>());
        ...
        spinnerStudies.setOnItemSelectedListener(new android.widget.AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(android.widget.AdapterView<?> parent, android.view.View view, int position, long id) {
                ...
                session.saveToPreferences(FinanceActivity.this);
                startLoad(false);
            }
    ...
    public void onCopyAccount(FinanceRecord record) {
        if (record == null || !record.hasAccount()) {
            Toast.makeText(this, R.string.finance_copy_account_missing, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void onCopyDetails(FinanceRecord record) {
        ...
        if (clipboard != null) {
            ...
            Toast.makeText(this, R.string.finance_copy_details_success, Toast.LENGTH_SHORT).show();
        }
    }
