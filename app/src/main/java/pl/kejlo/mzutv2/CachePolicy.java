...
public final class CachePolicy {
    ...
    public static final long STUDIES_TTL_MS = 10L * MINUTE_MS;
    public static final long SEMESTERS_TTL_MS = 10L * MINUTE_MS;
    public static final long GRADES_TTL_MS = 20L * MINUTE_MS;
    public static final long INFO_TTL_MS = 30L * MINUTE_MS;
    ...
    public static final long PLAN_ALBUM_TTL_MS = 6L * HOUR_MS;
    public static final long PLAN_USER_SCOPE_TTL_MS = 20L * MINUTE_MS;
    public static final long PLAN_SESSION_TTL_MS = 6L * HOUR_MS;
}
