...
public final class WearSyncConstants {
    ...
    public static final String ACTION_SNAPSHOT_UPDATED = "pl.kejlo.mzutv2.wear.SNAPSHOT_UPDATED";
    ...
    public static final String ACTION_SYNC_PROGRESS = "pl.kejlo.mzutv2.wear.SYNC_PROGRESS";
