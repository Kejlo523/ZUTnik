...
public class LoginActivity extends PhoneAwareActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.getUserId() != null && !session.isUsosLogin()) {
            MzutSession.clearSessionData(this);
            MzutSession.initializeFromPreferences(this);
            session = MzutSession.getInstance(this);
        }
        ...
        if (loginInfoText != null) {
            loginInfoText.setText(R.string.login_usos_info_text);
        }
