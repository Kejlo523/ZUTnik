 ...
 * Intercepts the mzutv2://oauth/callback redirect, performs the
    ...
    private void setupWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                if ("mzutv2".equals(uri.getScheme())) {
    ...
    private void handleOAuthCallback(Uri callbackUri) {
        ...
        executor.execute(() -> {
            try {
                ...
                // Save session
                MzutSession session = MzutSession.getInstance(UsosLoginWebActivity.this);
                ...
                handler.post(() -> {
                    ...
                    Intent i = new Intent(UsosLoginWebActivity.this, HomeActivity.class);
