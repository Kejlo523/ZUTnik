    ...
    public static void applyTheme(Activity activity) {
        ...
        switch (theme) {
            case THEME_DEEP_BLUE:
                activity.setTheme(R.style.Theme_ZUTnik_DeepBlue);
                break;
            case THEME_LIME:
                activity.setTheme(R.style.Theme_ZUTnik_Lime);
                break;
            case THEME_HIGH_CONTRAST:
                activity.setTheme(R.style.Theme_ZUTnik_HighContrast);
                break;
            case THEME_DEFAULT:
            default:
                activity.setTheme(R.style.Theme_ZUTnik);
                break;
        }
    }
